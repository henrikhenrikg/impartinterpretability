...
\enote{KS}{I am not sure if we should remove this paragraph
  to experiments section or leave here.}
\enote{hs}{i agree: better move it to the experimental section}
