...
\begin{abstract}
  Word embeddings
  %, which enable mapping of semantic properties of words
...
calculated based as a measure of  how strongly these
categories are represented in embedding dimensions. This
...
$S_k$. $n_{min}$ corresponds to the minimum number of words
required to construct a semantic category (i.e.\ represent a
...
An important benefit of interpretability in embedding models
is that individual dimensions clearly represent specific
concepts. The proposed imparting method is particularly
useful in this regard since it deliberately controls the
matching between concepts and dimensions. As 
